    ...
    <div class="container">
        <div class="form-container-wrapper">
            <div class="form-container cadastro">
                ...
                <form action="${pageContext.request.contextPath}/usuario/atualizar" method="post">
                    ...
                    <a href="${pageContext.request.contextPath}/usuario/listar" class="button back-link-button" style="margin-top: 10px;">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
