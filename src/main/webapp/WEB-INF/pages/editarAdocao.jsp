        ...
        <c:choose>
            <c:when test="${not empty adocao && not empty adocao.cachorro}">
                <div class="form-container" style="max-width: 700px; margin: 0 auto;">
                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/adocao/editar">
                        ...
                        <a href="${pageContext.request.contextPath}/adocao/minhas" class="button back-link-button" style="margin-top: 10px;">Cancelar</a>
                    </form>
                </div>
            </c:when>
            <c:otherwise>
                ...
                <div class="page-navigation-links" style="margin-top: 20px;">
                    <a href="${pageContext.request.contextPath}/adocao/minhas" class="action-button secondary">Voltar para Minhas Adoções</a>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
