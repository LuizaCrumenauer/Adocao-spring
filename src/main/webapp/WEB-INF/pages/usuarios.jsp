...
<div class="wrapper">
    ...
    <nav>
        <a href="${pageContext.request.contextPath}/usuario/dashboard_admin">Painel Admin</a>
            ...
            <a href="${pageContext.request.contextPath}/usuario/listar" class="active">Gerenciar Usuários</a>
    ...
    <div class="container">
                ...
                <c:forEach var="usuarioItem" items="${usuarios}">
                    <tr>
                        ...
                        <td data-label="Ações" class="table-actions">
                            <a href="${pageContext.request.contextPath}/usuario/editar/${usuarioItem.id}" class="table-action-button edit">Alterar</a>
                            <c:if test="${sessionScope.usuarioLogado.id != usuarioItem.id}">
                                <a href="${pageContext.request.contextPath}/usuario/excluir/${usuarioItem.id}"
        ...
        <div class="page-navigation-links">
            ...
            <a href="${pageContext.request.contextPath}/usuario/admin/cadastro" class="action-button primary">Cadastrar Novo Administrador</a>
        </div>
    </div>
</div>
<footer>
